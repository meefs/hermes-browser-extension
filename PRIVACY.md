...
This document describes shipped v0.1.9 behavior.

## No analytics

Hermes Browser Extension v0.1.9 does not include analytics, telemetry, ads, tracking pixels, or third-party reporting SDKs.
...
v0.1.9 supports two voice modes:
...
v0.1.9 displays live tool activity reported by Hermes during streaming turns. Tool labels/previews are sanitized locally before display and are not analytics, telemetry, or extra data collection. They reflect runtime events from the configured Hermes session.
...
If image upload is unavailable, v0.1.9 keeps images inline and shows a fallback warning.
